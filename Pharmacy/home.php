		    ...
		    <div class="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="index.html"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
		          ...
		          <li><a href="sell.php"><i class="fa fa-shopping-cart"></i><span>Sell Medicine</span></a></li>
		          <li><a href="viewstock.php"><i class="fa fa-eye"></i><span>View Stock Details</span></a></li>
		          <li><a href="viewsell.php"><i class="fa fa-file"></i><span>View Sell Report</span></a></li>
